...
while True:
    ...
    if not buttonA.value:  # just button A pressed
        ...
        draw.text(
            (x, y), "DNS Queries: {}".format(DNSQUERIES), font=font, fill="#FF00FF"
        )
        ...
        draw.text(
            (x, y), "Ads Blocked: {}".format(str(ADSBLOCKED)), font=font, fill="#00FF00"
        )
        ...
        draw.text(
            (x, y), "DNS Queries: {}".format(str(DNSQUERIES)), font=font, fill="#FF00FF"
        )
